...
public class LooksPrims {
	...
	public function addPrimsTo(primTable:Dictionary, specialTable:Dictionary):void {
		...
		specialTable['sayColorTime']                   = function(b:*):* { showBubbleColorWait(b, 'talk') };
...
//		primTable['yScroll']				= function(b:*):* { return app.stagePane.yScroll };
	...
	private function showBubbleColorWait(b:Array, type:String = null):void {
		var text:*, secs:Number;
		var s:ScratchSprite = interp.targetSprite();
		if (s == null) return;
		if (interp.activeThread.firstTime) {
			...
			var color:int;
			switch (b[1]){
				// Hey Icely, how about giving the user a color input for this?
				case "red":
					color = 0xFF0000;
					break;
				case "orange":
	...
	private function showBubbleColor(b:Array, type:String = null):void {
		var text:*, secs:Number;
		var s:ScratchSprite = interp.targetSprite();
		if (s == null) return;
		if (type == null) { // combined talk/think/shout/whisper command
	...
	private function primGoToBack(b:Array):void {
		var s:ScratchSprite = interp.targetSprite();
		if ((s == null) || (s.parent == null)) return;
